    ...
    <div class="flex h-screen overflow-hidden">
      ...
      <div class="w-64 bg-white border-r border-gray-200 flex flex-col h-full">
        ...
        <div class="p-4 border-t border-gray-200">
          ...
          >
            <i class="icon-[mdi-download] h-4 w-4"></i>
            Exportar JSON
          </button>
          ...
          >
            <i class="icon-[mdi-eye] h-4 w-4"></i>
            Vista Previa
          </button>
        </div>
      </div>
        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            >
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                ...
                >
                  ...
                  >
                    <i
                      class="icon-[mdi-page-layout-body] h-10 w-10 text-gray-400"
                    ></i>
                  </div>
              ...
              <div class="p-6" ref="contentGridRef">
                ...
                >
                  <div class="text-center">
                    <i
                      class="icon-[mdi-page-layout-body] h-12 w-12 text-gray-300 mx-auto mb-2"
                    ></i>
          ...
          >
            ...
            >
              ...
              >
                <i class="icon-[mdi-close] h-4 w-4"></i>
              </button>
            </div>
        ...
        <div class="p-6">
          <div class="flex justify-between items-center mb-4">
            ...
            <button
              ...
              class="text-gray-500 hover:text-gray-700"
            >
              <i class="icon-[mdi-close] h-5 w-5"></i>
            </button>
          </div>
...
const initGridStack = () => {
  ...
  gridStack.value.on("change", (event: any) => {
...
const renderBlock = (block: ContentBlock) => {
  ...
  <div class="absolute right-2 top-2 flex space-x-1 bg-white shadow-sm rounded-md p-1 z-10">
    <button class="duplicate-btn p-1 hover:bg-gray-100 rounded">
      <i class="icon-[mdi-content-copy] w-4 h-4"></i>
    </button>
    <button class="remove-btn p-1 hover:bg-gray-100 rounded text-red-500">
      <i class="icon-[mdi-delete] w-4 h-4"></i>
    </button>
  </div>
`;
